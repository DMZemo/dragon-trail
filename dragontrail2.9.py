...
game_data = {
    ...
    "player": {"name": "", "health": 100, "survival": 0, "carry_weight": 0, "defend_cooldown": 0, "stun_splosion_cooldown": 0},  # Initialize carry_weight
    "combat": {"potions": 0},
    "seed": 0
}
...
def collect_resource(resource_type, amount):
    ...
    elif resource_type == "wood" and amount % WOOD_CORD_SIZE != 0:
...
def handle_game_start():
    ...
    game_data["player"]["name"] = input("Enter your name: ").strip()
    ...
    # Ask for the seed
    seed_input = input("Enter a seed (word, phrase, or string of numbers): ").strip()
    game_data["seed"] = convert_seed_to_int(seed_input)
...
def reset_game():
    ...
    "resources": {"food": 10, "water": 8, "waterskins": 1, "herbs": 1, "supplies": 10,
                  "wood": 3, "wood_cords": 1, "gold": 0},
    "journey": {"totalMilesTraveled": 0, "dragon_encountered": False, "current_biome": "Marine"},
    "player": {"name": "", "health": 100, "survival": 0, "carry_weight": 0, "defend_cooldown": 0, "stun_splosion_cooldown": 0},
    "combat": {"potions": 0},
    "seed": 0
}
